...
import { SidebarMenuListItem, SidebarMenuListItemType } from '../components/SidebarMenuList/interface'
...
export const items: SidebarMenuListItem[] = [
	{
		key: 'home',
		href: '#',
...
export const sectionItems: SidebarMenuListItem[] = [
	{
		key: 'overview',
		title: 'Overview',
		items: [
...
export const sectionItemsWithTeams: SidebarMenuListItem[] = [
	...sectionItems,
	{
		key: 'your-teams',
		title: 'Your Teams',
...
export const brandItems: SidebarMenuListItem[] = [
	{
		key: 'overview',
		title: 'Overview',
		items: [
...
export const sectionLongList: SidebarMenuListItem[] = [
	...sectionItems,
	{
		key: 'payments',
		title: 'Payments',
