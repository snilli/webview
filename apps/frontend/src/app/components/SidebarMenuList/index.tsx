...
import { SidebarMenuListItem, SidebarMenuListItemType, SidebarMenuListProps } from './interface'

const SidebarMenuList = forwardRef<HTMLElement, SidebarMenuListProps>(
	(
		{
			items,
			isCompact,
		...
		return (
			...
			>
				{(item) => {
					...
					if (item.type === SidebarMenuListItemType.Nest) {
						return renderNestItem(item)
					}
